...
namespace NotasApp
{
    public partial class MainForm : Form
    {
        ...
        private readonly Color backgroundColor = Color.FromArgb(245, 245, 245);      // Fondo gris muy claro
        private readonly Color panelColor = Color.FromArgb(235, 235, 235);           // Panel gris claro
        private readonly Color cardColor = Color.FromArgb(250, 250, 250);            // Tarjetas gris casi blanco
        private readonly Color primaryColor = Color.FromArgb(120, 120, 120);         // Gris medio elegante
        private readonly Color accentColor = Color.FromArgb(95, 95, 95);             // Gris más oscuro para resaltar
        private readonly Color borderColor = Color.FromArgb(220, 220, 220);          // Bordes gris suave
        private readonly Color textColor = Color.FromArgb(50, 50, 50);               // Texto gris oscuro
        private readonly Color lightTextColor = Color.FromArgb(110, 110, 110);       // Texto gris medio
        private readonly Color hoverColor = Color.FromArgb(230, 230, 230);           // Hover gris cálido
        private readonly Color selectedColor = Color.FromArgb(215, 215, 215);        // Seleccionado gris suave
